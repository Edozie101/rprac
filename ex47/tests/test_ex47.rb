...
class TestGame < Test::Unit::TestCase
    ...
    def test_moroom_paths()
       first = Room.new("First","This room is the first room that you find yourself in there is a room to the north and to the south ")
       north = Room.new("north","This room seems like it is a place to store dead bodies you feel a cold chill down the back of your spine")
